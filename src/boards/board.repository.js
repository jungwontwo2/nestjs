...
var board_entity_1 = require("./board.entity");
var board_status_enum_1 = require("./board-status.enum");
var BoardRepository = /** @class */ (function (_super) {
    __extends(BoardRepository, _super);
    function BoardRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BoardRepository.prototype.createBoard = function (createBoardDto) {
        return __awaiter(this, void 0, void 0, function () {
            var title, description, board;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        title = createBoardDto.title, description = createBoardDto.description;
                        board = this.create({
                            title: title,
                            description: description,
                            status: board_status_enum_1.BoardStatus.PUBLIC
                        });
                        return [4 /*yield*/, this.save(board)];
                    case 1:
                        _a.sent();
